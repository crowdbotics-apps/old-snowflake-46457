"""
Django settings for old_snowflake_46457 project.
...
ROOT_URLCONF = 'old_snowflake_46457.urls'
...
WSGI_APPLICATION = 'old_snowflake_46457.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "old_snowflake_46457 API",
    "DESCRIPTION": "API documentation for old_snowflake_46457 App",
    "VERSION": "v1",
}
